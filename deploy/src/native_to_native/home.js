...
const HomeBridge = require('../../../build/contracts/HomeBridgeNativeToNative.json')
...
const HOME_GAS_PRICE = env.HOME_GAS_PRICE.toString(10)
const HOME_DAILY_LIMIT = env.HOME_DAILY_LIMIT.toString(10)
const HOME_MAX_AMOUNT_PER_TX = env.HOME_MAX_AMOUNT_PER_TX.toString(10)
const HOME_MIN_AMOUNT_PER_TX = env.HOME_MIN_AMOUNT_PER_TX.toString(10)
