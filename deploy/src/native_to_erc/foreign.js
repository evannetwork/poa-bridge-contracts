...
const FOREIGN_DAILY_LIMIT = env.FOREIGN_DAILY_LIMIT.toString()
const FOREIGN_MAX_AMOUNT_PER_TX = env.FOREIGN_MAX_AMOUNT_PER_TX.toString()
const FOREIGN_MIN_AMOUNT_PER_TX = env.FOREIGN_MIN_AMOUNT_PER_TX.toString()
const FOREIGN_GAS_PRICE = env.FOREIGN_GAS_PRICE.toString()
